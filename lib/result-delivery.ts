...
export function buildResultEmailText(report: ResultReport) {
  const lines = [
    ...
    "O PDF completo está anexado a este e-mail.",
    "",
    report.headline,
    report.score ?? "",
    report.summary,
